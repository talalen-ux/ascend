...
///         ascend is minted to the engine itself (permanently locked, since
...
contract Deploy is Script {
    function run() external {
        ...
        AscendEngine engine = new AscendEngine{value: 0.001 ether}();

        vm.stopBroadcast();

        console2.log("AscendEngine:", address(engine));
        console2.log("ascend      :", address(engine.ascend()));
